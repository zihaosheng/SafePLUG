...
safeplug_conv_vicuna_v1_original_system = Conversation(
...
# safeplug_conv_vicuna_v1 = Conversation(
...
default_conversation = safeplug_conv_vicuna_v1
conv_templates = {
    "v1": safeplug_conv_vicuna_v1,
    "safeplug_v1": safeplug_conv_vicuna_v1,
}
