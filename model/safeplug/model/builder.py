...
import torch
from model.safeplug.constants import (DEFAULT_IM_END_TOKEN, DEFAULT_IM_START_TOKEN,
                             DEFAULT_IMAGE_PATCH_TOKEN)
from model.safeplug.model import *
    ...
    if "llava" in model_name.lower():
        ...
        if model_base is not None:
            ...
            if "mpt" in model_name.lower():
                ...
                kwargs['vision_pretrained'] = vision_pretrained
                kwargs['test_only'] = True
                kwargs['max_sample_point'] = 512
                model = SafePLUGForCausalLM.from_pretrained(
                    model_path, low_cpu_mem_usage=True, **kwargs
                )
                print("===================>SafePLUGForCausalLM.from_pretrained success!!")

    image_processor = None

    if "safeplug" in model_name.lower():
        ...
        image_tower.to(device=device_map, dtype=kwargs["torch_dtype"])
        video_tower.to(device=device_map, dtype=kwargs["torch_dtype"])
